document.addEventListener('DOMContentLoaded', function() {
  ...
  if (phoneHeaderBtn) {
    phoneHeaderBtn.addEventListener('click', function() {
      const phoneNumber = '+972525080800';
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "NextRound uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '2113ce01-2446-408f-ba51-92ab1eb1496c',
                    name: data.name || '',
                    email: data.email || '',
